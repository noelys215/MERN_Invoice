...
export const PasswordResetPage = () => {
	...
	/* STATES */
	/*  level state will manage color display when passwordConfirm field is changed */
	...
	const handleShowHideConfirmPassword = () => setShowConfirmPassword(!showConfirmPassword);
	/* Prevent Default Mousedown Behavior */
	const handleMouseDownPassword = (event) => event.preventDefault();
	/* Run func when the password is typed/changed to show pass strength */
	const changePassword = (value) => setLevel(strengthColor(strengthIndicator(value)));
