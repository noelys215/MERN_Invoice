...
import { useCreatePaymentMutation, useUpdateDocMutation } from '../documentsApiSlice';

export const PaymentForm = ({ document }) => {
	const [createPayment, { isLoading, isSuccess, data }] = useCreatePaymentMutation();
