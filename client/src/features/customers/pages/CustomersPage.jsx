...
import { useDeleteCustomerMutation, useGetAllUserCustomersQuery } from '../customersApiSlice';
...
export const CustomersPage = () => {
	...
	// Avoid layout jump when reaching the end page w/empty rows.
									...
									<StyledTableCell>
										<Box
											...
											<FaEye
												...
												sx={{ cursor: 'pointer' }}
												onClick={() =>
													navigate(`/single-customer/${row._id}`)
												}
											/>
										</Box>
									</StyledTableCell>
