...
export default function ({ profile, document, balanceDue, status, totalAmountReceived }) {
	return `
	<!DOCTYPE html>
	<html>
	<head>
...
<body>
   <div class="container">
     ...
     <p>
       ...
       <b><span style="font-size: 16px">${addCurrencyCommas(document?.total.toFixed(2))}</span></b>
     </p>
       </div>
     </section>
     <hr class="divider">
           ...
           <table>
             ...
             <tr>
               ...
               <td style="text-align: right; font-size: 10px; font-weight: 700">${
                 ...
                 ${addCurrencyCommas(Math.round(document?.total - totalAmountReceived).toFixed(2))}
                 </td>
             </tr>
           </table>
